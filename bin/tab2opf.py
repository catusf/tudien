...
mapping_two_chars = {140: "O", 156: "o", 196: "A", 246: "o", 252: "u", 214: "O", 228: "a", 220: "U", 223: "s", 230: "e", 198: "E"}
...
def readkey(r, defs):
    ...
    nkey = nkey.replace('"', "'").replace("<", "\\<").replace(">", "\\>").lower().strip()
