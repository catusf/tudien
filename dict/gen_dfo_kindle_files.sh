...
print_to_file "Tu-dien-Phat-hoc-Anh-Han-Viet.dfo" "Từ điển Phật học Anh-Hán-Việt" "Từ điển Phật học Anh-Hán-Việt" "en" "vi" "1.0" "" "" "https://github.com/catusphan/dictionary" ""
